...
class PurchaseAdvancePaymentInv(models.TransientModel):
    ...
    def _default_product_id(self):
        product_id = self.env['ir.config_parameter'].sudo().get_param('mjb_purchase_downpayment.mjb_deposit_product_id')
    ...
    def _default_has_down_payment(self):
        if self._context.get('active_model') == 'purchase.order' and self._context.get('active_id', False):
            ...
            return purchase_order.order_line.filtered(
                lambda purchase_order_line: purchase_order_line.mjb_is_downpayment
            )
        return False
    ...
    def create_invoices(self):
        ...
        if self.advance_payment_method == 'received':
            ...
            if not self.product_id:
                ...
                self.env['ir.config_parameter'].sudo().set_param('mjb_purchase_downpayment.mjb_deposit_product_id', self.product_id.id)
